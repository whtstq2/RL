...
그걸 판단하기 위해 likelihood를 사용한다. 또한 베이스 가설에는 자의성이 들어갈 수 밖에 없는데 (모든 가설의 시작은 휴리스틱할 수 밖에 없다) 그 자의성이 적을 수 록 좋다. 왜냐 논리적 근거를 바탕으로 

출처: http://www.aistudy.com/math/likelihood.htm
> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzUyNDQ0MjEsMTMyMDIxOTM1OSwtMT
